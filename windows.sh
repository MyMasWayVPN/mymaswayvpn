...
case "$PILIHOS" in
	...
	2) wget --no-check-certificate -O- http://128.199.78.158/W10MasWay.gz | gunzip | dd of=/dev/vda bs=3M status=progress  IFACE="Ethernet Instance";;
	3) wget --no-check-certificate -O- http://128.199.78.158/windows10spectre.gz | gunzip | dd of=/dev/vda bs=3M status=progress  IFACE="Ethernet Instance";; 
	4) wget --no-check-certificate -O- http://128.199.78.158/windows12.gz | gunzip | dd of=/dev/vda bs=3M status=progress  IFACE="Ethernet Instance";; 
	5) wget --no-check-certificate -O- http://128.199.78.158/windows16.gz | gunzip | dd of=/dev/vda bs=3M status=progress  IFACE="Ethernet Instance";; 
	6) wget --no-check-certificate -O- http://128.199.78.158/windows22.gz | gunzip | dd of=/dev/vda bs=3M status=progress  IFACE="Ethernet Instance";; 
